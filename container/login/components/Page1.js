    ...
    return (
            ...
            <ImageBackground source={fondoS} style={{ paddingTop: Constants.statusBarHeight, flex: 1, height: windowHeight, width: '100%', resizeMode: "cover", }}>
                <View style={{ flex: 1, alignItems: 'center', flex: 1, paddingHorizontal: '5%', width: '100%' }}>
                    ...
                    <Image style={{ marginTop: 30, marginBottom: 30, height: 120, resizeMode: 'contain', width: '50%' }} source={require('../../../assets/iconPage1.png')} />
                    <Text style={{ fontSize: 18, marginBottom: 10, color: '#204089', fontWeight: 'bold' }}>¡No realices compras impulsivas!</Text>
                    <Text style={{ fontSize: 16, textAlign: 'center', marginBottom: 10, color: 'black' }}>Aunque parezcan atractivas, afectarán a tu capacidad de crédito.</Text>
                    <TouchableOpacity

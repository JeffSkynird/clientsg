...
import { eliminarCliente,registrarCliente } from "../../utils/API/clients.js";
...
const resetData = () => {
    ...
    const guardar = () => {
            ...
            let dat = {is_working:isWorking==true?1:0,charges:charges,rooms:rooms,answer_city:answerCity,amount_id:amount,location:location,spouse_dni:dniS,spouse_names:namesS,spouse_email:emailS,spouse_last_names:lastNamesS,spouse_cellphone:cellphoneS,spouse_landline:landlineS,dni:dni,names:names,last_names:lastNames,email:email,cellphone,landline,city,civil,born_date:date,street1:address,street2:calle2,village:villa,description:descripcion}
        
            if (validarCedula(dni)) {
                registrarCliente(
                    dat,
                    initializer,mostrarNotificacion,resetData,setLoading
                );
            } else {

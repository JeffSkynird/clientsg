...
export const obtenerDataManager = (setData, store) => {
  ...
  export const obtenerManagers = (setData, store) => {
    ...
    let url = ENTRYPOINT+"manager/all";
    let setting = {
      method: "GET",
      url: url,
      headers: {
  ...
  export const editarManager = (data, store,asignarR,history) => {
    const { usuario, mostrarNotificacion, mostrarLoader } = store;
   
 
    let url = ENTRYPOINT+"manager/editar";
    let setting = {
      method: "POST",
      url: url,
      data: data,
  ...
  export const editPassword = (data, store) => {
    ...
    let url = ENTRYPOINT+"manager/edit_password";
    let setting = {
      method: "POST",
      url: url,
      data: data,
  ...
  export const editPasswordAdmin = (data, store) => {
    ...
    let url = ENTRYPOINT+"manager/edit_password_admin";
    let setting = {
      method: "POST",
      url: url,
      data: data,
  ...
  export const registrarUsuario = (data, store,asignarR,history) => {
    const { usuario, mostrarNotificacion, mostrarLoader } = store;
   
 
    let url = ENTRYPOINT+"manager/register";
    let setting = {
      method: "POST",
      url: url,
      data: data,
  ...
  export const eliminarManager = (city_id,store,cargarData) => {
    ...
    let url = ENTRYPOINT+"manager/delete";
    var raw = {
        manager_id:city_id,
    };
    let setting = {
